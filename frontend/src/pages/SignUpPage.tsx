...
import { LoaderIcon, Lock, Mail, MessageCircleIcon, UserIcon } from 'lucide-react';
          ...
          <div className='md:w-1/2 p-8 flex items-center justify-center md:border-r border-slate-600/30'>
            <div className='w-full max-w-md'>
              ...
              <form onSubmit={handleSubmit} className='space-y-6'>
                ...
                {/* submit button */}
                <button className='auth-btn' disabled={isSigningUp} type='submit'>{isSigningUp ? ( <LoaderIcon className='w-full h-5 animate-spin text-center' />) : "Create an account"}</button>
              </form>
